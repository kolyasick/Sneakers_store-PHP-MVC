  ...
  <?php foreach ($orders as $order) : ?>
    ...
    <tr class="border border-slate-400 text-center">
      ...
      <td class="border border-slate-400 px-2 py-3 w-1/8">
        <a class="block" href="/myProject2.loc/admin/order/<?= $order->getId() ?>/view">
          <img width="30" src="/myProject2.loc/public/magnifier.png" alt="">
        </a>
      </td>
      <td class="px-2 py-3 w-1/10">
        <a class="block" href="/myProject2.loc/admin/order/<?= $order->getId() ?>/delete">
      ...
      <td class="px-2 py-3 w-1/8">
        <form action="/myProject2.loc/admin/order/<?= $order->getId() ?>/edit" method="post">
