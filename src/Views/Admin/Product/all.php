  ...
  <?php foreach ($products as $product) : ?>
    ...
    <tr class="border border-slate-400 text-center">
      ...
      <td class="px-2 py-3 w-1/10 flex justify-around border-0">
        <a class="block" href="/myProject2.loc/admin/product/<?= $product->getId() ?>/view">
          <img width="30" src="/myProject2.loc/public/magnifier.png" alt="">
        </a>
        <a class="block" href="/myProject2.loc/admin/product/<?= $product->getId() ?>/edit">
          <img width="30" src="/myProject2.loc/public/pencil.png" alt="">
        </a>
        <a class="block" href="/myProject2.loc/admin/product/<?= $product->getId() ?>/delete">
...
<a class="inline-block border-2 border-slate-400 p-3 mt-5 hover:bg-slate-300 transition font-semibold text-center" href="/myProject2.loc/admin/product/add">Добавить товар</a>