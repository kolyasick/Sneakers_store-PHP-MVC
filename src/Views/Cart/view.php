<div class="text-center w-full mx-auto">
    <ul class="flex gap-1 items-center justify-center">
        ...
        <li>
            <a href="/product/all">Товары</a>
        </li>
        <li>
            >
        </li>
        <li>
            <a class="text-gray-400" href="/product/all">Корзина</a>
        </li>
    </ul>
</div>
...
<div class="grid grid-cols-4 gap-5">
    <?php foreach ($_SESSION['cart'] as $key => $value): ?>
                ...
                <div class="relative bg-white border border-slate-200 rounded-3xl p-8 cursor-pointer transition hover:-translate-y-2 hover:shadow-xl">
                    <a href="/cart/delete-in-cart/<?= $value['id']; ?>"><img src="/public/close.svg" alt="Like 1" class="absolute top-8 left-8"></a>
                    <img src="/public/sneakers/<?= $value['img']; ?>" alt="Sneaker">
                    ...
                    <div class="flex justify-between mt-5">
                        ...
                        <div class="flex gap-2 align-end justify-center">
                            <a href="/cart/delete/<?= $value['id']; ?>"><img width="30" class="border border-slate-300 rounded-md" src="/public/minus.svg" alt="Plus"></a>
                            <p class="text-center font-light"><b> <?= $value['qty'] ?></b></p>
                            <a class="addToCartPlus" href="/cart/add/<?= $value['id']; ?>"><img src="/public/plus.svg" alt="Plus"></a>
                        </div>
                    </div>
                </div>
    <?php endforeach; ?>
...
<p class=" mt-3">
    ...
    <br><br><a href="/cart/clear" class="bg-red-500 text-white p-3 rounded-md">Очистить корзину</a>
    <a href="/cart/order" class="bg-lime-500 text-white p-3 rounded-md">ОФормить заказ</a>
</p>
