<div class="text-center w-full mx-auto">
    <ul class="flex gap-1 items-center justify-center">
        ...
        <li>
            <a class="text-gray-400" href="/product/all">Товары</a>
        </li>
    </ul>
</div>
...
<?php foreach ($categories as $category) : ?>
   <a class="w-1/4 border rounded-md border-gray-400 p-3 mb-2 text-center hover:bg-gray-300 transition" href="/categories/<?= $category->getId() ?>">
