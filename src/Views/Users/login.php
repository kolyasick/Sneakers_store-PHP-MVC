<div class="flex flex-col items-center">
    ...
    <?php if (!empty($error)): ?>
        ...
        "><?= $error ?></div>
    <?php endif; ?>
    <form class="border border-gray-400 border rounded-xl p-5 w-1/4" action="/users/login" method="POST">
        ...
        <div class="mt-5 flex gap-2">
            <p>Нет аккунта?</p>
            <a class="underline text-blue-500" href="/users/register">Зарегистрироваться</a>
        </div>
    </form>
</div>