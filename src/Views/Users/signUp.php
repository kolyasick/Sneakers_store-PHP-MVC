...
<?php if (!empty($error)): ?>
    ...
    "><?= $error ?></div>
<?php endif; ?>
<form class="border border-gray-400 border rounded-xl p-5 w-1/4" action="/myProject2.loc/users/register" method="POST">
    ...
    <div class="mt-5 flex gap-2">
            <p>Есть аккаунт?</p>
            <a class="underline text-blue-500" href="/myProject2.loc/users/login">Войти</a>
        </div>
</form>
